...
public abstract class FilePath {
	...
	public static String inputFolder              = "input_political"                      + File.separator;
	...
	public static String policyFolder             = inputFolder        + "policy"          + File.separator;
	...
	public static String populationFolder         = humanAgentFolder   + "agents"          + File.separator;
