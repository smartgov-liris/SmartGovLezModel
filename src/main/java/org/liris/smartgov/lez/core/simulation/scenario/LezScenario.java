...
public class LezScenario extends PollutionScenario {
	...
	public Map<String, Establishment> loadEstablishments(SmartGovContext context, CopertParser parser) {
		...
		for (Establishment establishment : establishments.values()) {
			...
			//Personalities type are not used for now
		...
		//if we need to create political layer, we crate it from environment
	...
	public static class NoLezDeliveries extends LezScenario {
