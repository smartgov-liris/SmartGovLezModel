...
The `politic run` task will launch reinforcement learning module in order to learn optimal policy. Environments created will
be saved in json files, in the `output_political` folder. As the simulation is mainly mono-core, it takes a long time to learn optimal policies.
